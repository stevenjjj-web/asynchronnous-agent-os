export const COMMAND_CATALOG = Object.freeze([
  ...
  { name: '/security', usage: '/security', group: 'Observe', description: 'Run the live Gateway security audit' },
  ...
  { name: '/memory-sync', usage: '/memory-sync', group: 'Context', description: 'Show memory providers and recent import/export runs' },
